...
def test_render(scene_four_spheres_, generate=False):
    ...
    if generate:
        ...
        conftest.assert_image_approx_equal(buf_proxy[:], dir_path / 'reference' / 'test_geometry_sphere.test_render.png')
...
def test_radius(scene_four_spheres_, generate=False):
    ...
    if generate:
        ...
        conftest.assert_image_approx_equal(buf_proxy[:], dir_path / 'reference' / 'test_geometry_sphere.test_radius.png')
...
def test_position(scene_four_spheres_, generate=False):
    ...
    if generate:
        ...
        conftest.assert_image_approx_equal(buf_proxy[:], dir_path / 'reference' / 'test_geometry_sphere.test_position.png')
...
def test_color(scene_four_spheres_, generate=False):
    ...
    if generate:
        ...
        conftest.assert_image_approx_equal(buf_proxy[:], dir_path / 'reference' / 'test_geometry_sphere.test_color.png')
...
def test_outline(scene_four_spheres_, generate=False):
    ...
    if generate:
        ...
        conftest.assert_image_approx_equal(buf_proxy[:], dir_path / 'reference' / 'test_geometry_sphere.test_outline.png')
