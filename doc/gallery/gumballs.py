...
colors = ['#e56d60', '#ee9944', '#716e80', '#eadecd', '#cec746', '#c0443f',
          '#734d56', '#5d5f7b', '#ecb642', '#8a9441']
...
scene.lights.append(fresnel.light.Light(direction=(0.3, -0.3, 1), color=(0.5, 0.5, 0.5), theta=np.pi))
