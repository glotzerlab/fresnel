...
/*! \param verts Vertices of the convex polyhedron
    ...
    Compute the convex hull of a set of vertices and return a python dictionary containing the face information
    needed for cpu::GeometryConvexPolyhedron and gpu::GeometryConvexPolyhedron.
*/
pybind11::dict find_polyhedron_faces(pybind11::array_t<double, pybind11::array::c_style | pybind11::array::forcecast> verts)
    ...
    retval["face_origin"] = pybind11::array_t<float>({face_origin.size(), size_t(3)}, (float*)&face_origin[0]);
    retval["face_normal"] = pybind11::array_t<float>({face_normal.size(), size_t(3)}, (float*)&face_normal[0]);
    retval["face_color"] = pybind11::array_t<float>({face_color.size(), size_t(3)}, (float*)&face_color[0]);
