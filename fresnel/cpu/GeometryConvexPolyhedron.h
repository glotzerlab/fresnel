...
/*! Define a convex polyhedron geometry.
    ...
    Attempt 1 at supporting convex polyhedron geometries. Store convex a convex polyhedron as a list of planes
    and perform the needed ray-plane intersection tests to find intersections. Determine edge distance by computing
    plane-plane intersections to find edges. This method works, it is unclear if it performs well compared to possible
    other methods.
*/
