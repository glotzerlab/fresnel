...
void export_Array(pybind11::module& m)
    {
    pybind11::class_<Array< RGBA<float> >, std::shared_ptr<Array< RGBA<float> >> >(m, "ArrayRGBAf", pybind11::buffer_protocol())
    ...
    pybind11::class_<Array< RGBA<unsigned char> >, std::shared_ptr<Array< RGBA<unsigned char> >> >(m, "ArrayRGBAc", pybind11::buffer_protocol())
    ...
    pybind11::class_<Array< RGB<float> >, std::shared_ptr<Array< RGB<float> >> >(m, "ArrayRGBf", pybind11::buffer_protocol())
    ...
    pybind11::class_<Array< RGB<unsigned char> >, std::shared_ptr<Array< RGB<unsigned char> >> >(m, "ArrayRGBc", pybind11::buffer_protocol())
    ...
    pybind11::class_<Array< vec3<float> >, std::shared_ptr<Array< vec3<float> >> >(m, "ArrayVec3f", pybind11::buffer_protocol())
    ...
    pybind11::class_<Array< vec2<float> >, std::shared_ptr<Array< vec2<float> >> >(m, "ArrayVec2f", pybind11::buffer_protocol())
    ...
    pybind11::class_<Array< quat<float> >, std::shared_ptr<Array< quat<float> >> >(m, "ArrayQuat3f", pybind11::buffer_protocol())
    ...
    pybind11::class_<Array< float >, std::shared_ptr<Array< float >> >(m, "Array_f", pybind11::buffer_protocol())
